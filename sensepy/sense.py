...
class SensingAlgorithm:
    ...
    def step(self, actions: List, verbose: bool = False, points: bool = False):
        """
    ...
    def best_point_so_far(self, D: BorelSet, n: int) -> torch.Tensor:
        """
...
class EpsilonGreedySense(SensingAlgorithm):
    ...
    def __init__(
        ...
        w: Callable,
        initial_data=None,
        epsilon: Callable = lambda t: 1.0 - 1.0 / np.sqrt(t),  # eps-probability decay
        dt: float = 10.0,
        topk: int = 1,
    ) -> None:
        """
